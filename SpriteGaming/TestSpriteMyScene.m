...
//  SpriteGaming
//
//  Created by Ishang Bhan on 12/29/2013.
//  Copyright (c) 2013 Ishang Bhan. All rights reserved.
//

#import "TestSpriteMyScene.h"

@implementation TestSpriteMyScene
...
-(id)initWithSize:(CGSize)size {    
    if (self = [super initWithSize:size]) {
        ...
        SKAction *action = [SKAction moveTo:_plane.position duration:12.2];
        [_plane runAction:[SKAction repeatActionForever:action]];
        
        [self addChild:_plane];
        
        //adding the plane shadow
        ...
        [_planeShadow runAction:[SKAction repeatActionForever:action]];
